const menu = [
 ...
 // Buttons
  ...
  const btnclass = document.querySelector(".btn-container")
  ...
  categoryNames.forEach(function(item){
    ...
    btnclass.appendChild(button)
  })

 // Content
 const row = document.querySelector(".section-center")
...
// Başlangıçta tüm arrayi döndürür
menuList(menu);